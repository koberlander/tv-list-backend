...
nine_nine = Program.create!(id: 2, url: 'http://www.tvmaze.com/shows/49/brooklyn-nine-nine', name: 'Brooklyn 99', network: 'NBC', image: 'http://static.tvmaze.com/uploads/images/medium_portrait/177/444232.jpg', watchlist: false)
...
broad_city = Program.create!(id: 9, url: 'http://www.tvmaze.com/shows/375/broad-city', name: 'Broad City', network: 'Comedy Central', image: 'http://static.tvmaze.com/uploads/images/medium_portrait/52/130656.jpg', watchlist: false)
...
mick = Program.create!(id: 15, url: 'http://www.tvmaze.com/shows/12604/the-mick', name: 'The Mick', network: 'FOX', image: 'http://static.tvmaze.com/uploads/images/medium_portrait/147/369361.jpg', watchlist: false)

city_on_hill = Program.create!(id: 16, url: 'http://www.tvmaze.com/shows/30780/city-on-a-hill', name: 'City on a Hill', network: 'Showtime', image: 'http://static.tvmaze.com/uploads/images/medium_portrait/194/486341.jpg', watchlist: true)
...
# party_down = Program.create!(url: 'http://www.tvmaze.com/shows/1137/party-down', name: 'Party Down', network: 'Starz', image: 'http://static.tvmaze.com/uploads/images/medium_portrait/6/17310.jpg', watchlist: false)
#
# thick_of_it = Program.create!(url: 'http://www.tvmaze.com/shows/1667/the-thick-of-it', name: 'The Thick of It', network: 'BBC Four', image: 'http://static.tvmaze.com/uploads/images/medium_portrait/9/22970.jpg', watchlist: true)
